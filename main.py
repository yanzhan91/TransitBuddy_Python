...
def launch():
    ...
    return question(welcome_text)\
        .simple_card('Welcome to TransitBuddy', remove_html(welcome_text))\
        .reprompt(render_template('help'))


@ask.intent('AMAZON.HelpIntent')
def help():
    return statement(render_template('help')).simple_card('TransitBuddy Help', render_template('help_card'))
